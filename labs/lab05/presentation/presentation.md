...
![Выполнение пункта 2](2.jpg){ #fig:002 width=90% }
...
![Выполнение пункта 3](3.jpg){ #fig:003 width=90% }

4. Просмотрите содержимое файла /etc/password (рис. 4) 

![cat /etc/passwd](4.jpg)jp{ #fig:004 width=90% }
...
![Выполнение пункта 4](4.jpg){ #fig:005 width=90% }

6. Прочитайте man по командам mount, fsck, mkfs, kill (рис 8)

![man по командам](5.jpg){ #fig:006 width=90% }
